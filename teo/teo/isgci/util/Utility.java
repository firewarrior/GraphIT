...
public final class Utility {
    ...
    /**
     * Returns a shortened name of a graph class with "..." at the end. If a
     * graph class had a name shorter than 40 symbols, returns the name itself.
     * Used when the name of a graph class is too long for putting on a drawing
     * or in the Dialog for changing name.
     * 
     * @param name
     *            a full name of the graph class
     */
    public static String getShortName(String name) {
        if (name.length() <= 40)
            return name;

        int breakSymbol, lastComma, lastSpace, lastOpenBracket, lastCloseBracket;
