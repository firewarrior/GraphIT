...
/**
 * A Pair is an object that contains two other objects. It is most commonly used
 * for conveniently storing and passing pairs of objects.
 * <p>
 * 
 * @version 3.1.0
...
public class Pair<E, F> {
    ...
    public boolean equals(Pair pair) {
        ...
        return (first == null ? pair.first == null : first.equals(pair.first))
                && (second == null ? pair.second == null : second
                        .equals(pair.second));
    }
