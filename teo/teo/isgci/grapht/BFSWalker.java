...
public class BFSWalker<V, E> extends GraphWalker<V, E> {
     ...
     *            nothing
     */
    public BFSWalker(DirectedGraph<V, E> graph, V start,
     ...
     * g.addEdge("c", "u"); g.addEdge("i", "k"); g.addEdge("i", "q");
     * g.addEdge("i", "u"); g.addEdge("u", "i"); g.addEdge("u", "c");
     * g.addEdge("q", "u"); g.addEdge("q", "i");
     * 
     * new BFSWalker<String,DefaultEdge>(g, "q", null,
     * GraphWalker.InitCode.DYNAMIC) { public void visit(String v) {
     * System.out.print(v); super.visit(v); } }.run(); System.out.println(); }
     */
}
