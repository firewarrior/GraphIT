...
public class TreeBFSWalker<V, E> extends UBFSWalker<V, E> {
    ...
    public TreeBFSWalker(DirectedGraph<V, E> graph, V start,
    ...
    /**
     * Explore the edge e in the direction from - to. Do NOT check whether to is
     * seen already, if so the tree edges would not be a tree.
     */
