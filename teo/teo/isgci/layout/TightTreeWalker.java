 ...
 * tree-edges (GraphDrawingInfo). The result is a spanning tree for the graph.<br>
 * This class is supposed to be used for the network simplex algorithm in
 * HierarchyLayout
 */
public class TightTreeWalker<V, E> extends UBFSWalker<V, E> {
    ...
    public TightTreeWalker(DirectedGraph<V, E> graph, V start,
