...
public abstract class SetClass extends GraphClass {
    ...
    /**
     * Return the set of GraphClasses this is defined upon. We don't need to
     * copy since gcSet is already unmodifiable.
     */
     ...
     * base-classes with infix (e.g. \cap or \cup).
     */
     ...
     * constructed from equal classes.
     */
