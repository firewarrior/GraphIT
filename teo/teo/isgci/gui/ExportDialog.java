...
public class ExportDialog extends JDialog implements ActionListener {
    ...
    public ExportDialog(ISGCIMainFrame parent,
        ...
        m_shortLabels
                .setToolTipText("Use shortened labels for nodes. Long labels may case clipping issues.");
        m_shortLabels.addActionListener(this);
        m_relayout = new JCheckBox("Relayout", false);
        m_relayout
                .setToolTipText("Relayout will fix clipping issues caused by long node labels, but has side effects i.e. move single nodes to the top.");
