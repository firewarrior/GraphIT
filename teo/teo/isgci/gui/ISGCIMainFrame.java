...
public class ISGCIMainFrame extends JFrame implements WindowListener,
    ...
    protected JPanel createInformationPanel() {
        ...
        undoButton = new JButton(Character.valueOf('\u21A9').toString());
        ...
        cLayout.gridy = 1;
        cLayout.fill = GridBagConstraints.HORIZONTAL;
        redoButton = new JButton(Character.valueOf('\u21AA').toString());
        redoButton.setToolTipText("Redo last change");
        ...
        relayoutButton.setToolTipText("Relayout the displayed graph");
        ...
        zoomToFit.setToolTipText("Fits the whole graph into the canvas");
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (!xCanvas.getGraphClassList().isEmpty()) {
