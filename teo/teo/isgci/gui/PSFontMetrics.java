...
public class PSFontMetrics extends FontMetrics {
    ...
    static int[] cw = { 0, 0, 0, 0, 0, 0, 0,
            ...
            278,
            278, // 32
            556, 555, 556, 556, 556, 556, 556, 556,
            556,
            556,
            278,
            278,
            ...
            278,
            469, // 80
            222, 556, 556, 500, 556, 556, 278, 556, 556, 222, 222,
            500,
            222,
            833,
            556,
            556, // 96
            556, 556, 333, 500, 278, 556, 500, 722, 500, 500, 500, 334,
            260,
            334,
            584,
            0, // 112
            ...
            0,
            0, // 144
            0, 333, 556, 556, 167, 556, 556, 556, 556, 191, 333, 556, 333,
            333,
            500,
            500, // 160
            0, 556, 556, 556, 278, 0, 537, 350, 222, 333, 333, 556, 1000,
            1000, 0,
            611, // 176
            0, 333, 333, 333, 333, 333, 333, 333, 333, 0, 333, 333, 0, 333,
            333, 333, // 192
    ...
    /**
     * Gets the font ascent. The font ascent is the distance from the base line
     * to the top of most Alphanumeric characters. Note, however, that some
    ...
    /**
     * Gets the font descent. The font descent is the distance from the base
     * line to the bottom of most Alphanumeric characters. Note, however, that
     * some characters in the font may extend below this height.
     * 
     * @see #getMaxDescent
     */
    ...
    /**
     * Returns the advance width of the specified character in this Font. The
     * advance width is the amount by which the current point is moved from one
     * character to the next in a line of text.
     * 
     * @param ch
