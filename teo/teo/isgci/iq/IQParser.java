//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-06-25 08:48:18 GMT
//  from grammar 'D:\git\GraphIT\teo\teo\isgci\iq\iq.peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term17)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term4)) return reject(name);
      if (!next('"',$Term0)) return reject(name);
      thename();
      if (!next('"',$Term4)
       && !EOL()
         ) return reject(name);
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('a','z',$Term13)) return accept(idstart);
  ...
  private boolean idchar()
    {
      ...
      if (nextIn('0','9',$Term5)) return accept(idchar);
      if (next('_',$Term16)) return accept(idchar);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term14)) return reject(or);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term11)) return reject(and);
  ...
  private boolean lparen()
    {
      ...
      if (!next('(',$Term18)) return reject(lparen);
      space();
  ...
  private boolean rparen()
    {
      ...
      if (!next(')',$Term19)) return reject(rparen);
      space();
  ...
  private boolean EOF()
    {
      ...
      if (!aheadNot($Term17)) return reject(EOF);
      return accept(EOF);
    }
  ...
  final Cache $Term5 = new Cache("[0-9]");
  ...
  final Cache $Term11 = new Cache("\"and\"");
  final Cache $Term12 = new Cache("^[\"\r\n]");
  final Cache $Term13 = new Cache("[a-z]");
  final Cache $Term14 = new Cache("\"or\"");
  final Cache $Term15 = new Cache("[ \t\r\n]");
  final Cache $Term16 = new Cache("\"_\"");
