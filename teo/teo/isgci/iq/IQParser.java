//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2013-06-19 19:09:07 GMT
//  from grammar 'E:\GitHub\GraphIT\teo\teo\isgci\iq\iq.peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean top_1()
    {
      ...
      do if (!next($Term14)) return rejectInner(top_1);
        while (!EOF());
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term7)) return reject(name);
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('a','z',$Term18)) return accept(idstart);
  ...
  private boolean idchar()
    {
      ...
      if (nextIn('0','9',$Term19)) return accept(idchar);
      if (next('_',$Term2)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term8)) return reject(not);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term16)) return reject(and);
  ...
  private boolean rparen()
    {
      ...
      if (!next(')',$Term10)) return reject(rparen);
      space();
  ...
  final Cache $Term8 = new Cache("\"not\"");
  ...
  final Cache $Term16 = new Cache("\"and\"");
  final Cache $Term17 = new Cache("\"or\"");
  final Cache $Term18 = new Cache("[a-z]");
  final Cache $Term19 = new Cache("[0-9]");
