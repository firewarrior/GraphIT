...
public class PermutationMask {
    ...
    public boolean next() {
        /*
         * Algorithmus suche von hinten erste Stelle p, wo
         * element[p]<element[p+1] suche von hinten erste Stelle p2, wo
         * element[p]<element[p2] tausche element[p]<->element[p2] setze p eine
         * Position nach hinten wenn p<element.length-1 (=p1), sortiere
         * elemnt[p]..element[p1] weil das ganze schon (rueckwaerts) sortiert
         * ist reicht es, den ersten mit dem letzten, den zweiten mit dem
         * vorletzten usw zu vertauschen
         * 
        ...
        while (--p >= 0)
            if (element[p] < element[p + 1] && element[p] < einsen
                    && element[p + 1] >= einsen)
                break;
