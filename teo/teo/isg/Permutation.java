...
public class Permutation {
    ...
    /**
     * Creates a new Permutation-Object with <tt>n</tt> elements and initializes
    ...
    public boolean next() {
        ...
        /*
         * an der Stelle pos ein Element positionieren, das größer als das
         * bisherige ist, den Rest nach dem normalen Verfahren auffüllen
         */
        for (int j = element[pos] + 1; j < anzahl; j++)
            if (darf[pos][j] && !used[j]) {
                used[j] = true;
